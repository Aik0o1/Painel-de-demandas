...
async def create_contract(contract: ContractCreate, user: User = Depends(check_permission("financeiro", "create")), db_session: AsyncSession = Depends(get_db)):
    now = datetime.utcnow()
...
async def update_contract(id: str, update_data: ContractUpdate, user: User = Depends(check_permission("financeiro", "update")), db_session: AsyncSession = Depends(get_db)):
...
async def delete_contract(id: str, user: User = Depends(check_permission("financeiro", "delete")), db_session: AsyncSession = Depends(get_db)):
